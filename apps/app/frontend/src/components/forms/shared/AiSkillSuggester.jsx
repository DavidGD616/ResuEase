...
function AISkillSuggester({ jobTitle, currentSkills = [], onAddSkill, skillType = 'soft' }) {
  ...
  const handleGetSuggestions = async () => {
    ...
    const currentSkillNames = currentSkills.map(skill => 
      skill.skillName || skill.technologiesSkillName
    ).filter(Boolean);

    // Call appropriate AI service based on skill type
    const result = skillType === 'technical'
